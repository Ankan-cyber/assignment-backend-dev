...
const Account = () => {
    ...
    const { getUser, user, changePassword, verifyAdminAccess } = context;
        ...
        <>
            ...
            <form className='mb-4' onSubmit={handleClick}>
                ...
                <div className="mb-3">
                    ...
                    <input type="text" className="form-control" id="role" aria-describedby="role" disabled={true} value={user.role || "user"} />
                </div>
                <div className="mb-3">
                ...
                <button type="button" className="btn btn-outline-secondary mx-2" onClick={verifyAdminAccess}>
